...
$status1 = array
  (
    ...
    array("E1ReadyForThesisReview",NULL),
    ...
    array("E1ApprovedHonInitiated",NULL)
   );
   $status2 = array
     (
       ...
       array("E2ReadyForThesisReview",NULL),
       ...
       array("E2ApprovedHonInitiated",NULL)
      );
...
<input type="date"  name="date" value= "<?php echo $date1 ?> " placeholder="Date" required="true">
<br>
...
<br>
<label >Modified Date</label>
<input type="date"  name="date"  value= "<?php echo $date2 ?> "  placeholder="Date" required="true">
