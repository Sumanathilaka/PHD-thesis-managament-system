...
$search=mysqli_real_escape_string($conn, $_POST['status2']);
$sql = "SELECT name,project.rollno,email,department,guide,guidemail,topic,status2,date2
...
echo  "<table id = 'records'>";
 ...
 <?php echo "<tr><td>", $row['name'] , "</td><td>" , $row['rollno'] , "</td><td>" , $row['topic'] , "</td><td>" ,
  $row['guide'] , "</td><td>", $status2[$row['status2']][0] , "</td><td>" , $row['date2'],
